...
def main():
    folder1 = '/home/madhy/Documents/fairness_testing/MT_Testcase_generation/propsed approach/substitution/one/output_substitution_one/output_1/'  # Replace with the actual folder path
