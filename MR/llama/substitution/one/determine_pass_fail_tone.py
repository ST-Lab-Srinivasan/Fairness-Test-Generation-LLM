...
directory_path = '/home/madhy/Documents/fairness_testing/MT_Testcase_generation/propsed approach/substitution/one/'  # Replace this with the actual path
file_name = 'result_tone_bert_check.txt'
